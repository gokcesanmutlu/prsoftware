...
const Header = () => {
  ...
  return (
    <>
      ...
      {isModalOpen ? (
        <div className="py-6 w-[375px] flex flex-col gap-1 menu-breakmin:hidden absolute top-[72px] bg-[#fff] z-[80px] right-0">
      ...
      {isResourcesOpen ? (
        <div className="out w-full h-auto menu-breakmax:hidden absolute bg-[#fff] z-[80px] right-0 ">
          <div

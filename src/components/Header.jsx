...
const Header = () => {
  ...
  return (
    <>
      ...
      {isModalOpen ? (
        <div className="py-6 w-[375px] flex flex-col gap-4 menu-breakmin:hidden fixed top-[72px] bg-[#fff] z-[80px] right-0">
          <Link to="/">Home</Link>
          <Link
            to="/"
            onClick={() => setIsResourcesOpen(!isResourcesOpen)}
...
{/* BÜYÜK EKRANDA RESOURCES */}
      {isResourcesOpen ? (
        <div
          className="out w-full h-auto menu-breakmax:hidden"
        >
          <div
